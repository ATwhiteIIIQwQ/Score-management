      ...
      <div class="card-body">
        <form @submit.prevent="handleSearch">
          <div class="d-flex flex-row align-items-center mb-3">
            <label for="studentId" class="col-form-label text-center me-2" style="width: 70px;">学生</label>
            <select id="student" v-model="score.studentId" class="form-select me-3" style="width: 250px;">
        ...
        <div class="modal-body">
          <form @submit.prevent="handleSubmit">
            <div class="row mb-3">
              ...
              <div class="col-10">
                <select id="student" v-model="form.studentId" class="form-select" :class="{ disabled: isEdit === ture }">
                  <option v-for="student in students" :value="student.studentId" :key="student.studentId">
                    {{ student.studentName }}
                  </option>
                </select>
            ...
            <div class="row mb-3">
              ...
              <div class="col-10">
                <select id="course" v-model="form.courseId" class="form-select" :class="{ disabled: isEdit === true }">
                  <option v-for="course in courses" :value="course.courseId" :key="course.courseId">
                    {{ course.courseName }}
                  </option>
                </select>
...
export default {
  ...
  methods: {
    ...
    async handleSearch() {
      try {
        const response = await scoreApi.searchScores(this.score);
